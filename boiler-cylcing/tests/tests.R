...
stack1 <- process_data(stack1_f,periodicity_15 = TRUE,target_columns=c("K-Type"),state_change_data = FALSE)
stack2 <- process_data(stack2_f,periodicity_15 = TRUE,target_columns=c("K-Type"),state_change_data = FALSE)
